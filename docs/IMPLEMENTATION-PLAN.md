...
Candidate `357a225cd2d27b030abc1d3a6692ab9841616760` supersedes the earlier `6fee782ce93458ebcd10f7be3e1f2018ce1bd08d` baseline. On September 5, 2026, its existing exact-revision CI, eleven-surface UI, stress, and runtime records reported passed, and the installed candidate passed provenance, signature, Gatekeeper, staple, executable-hash, and release-bundle revalidation. Its physical acceptance record remains incomplete with 8 of 19 gates confirmed. See [owner release acceptance](OWNER-RELEASE-ACCEPTANCE.md) for the exact artifact, remaining 11 gates (including Spaces), evidence location, and final owner decision requirements. No new physical observations or publication approval are implied by this review.
