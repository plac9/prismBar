...
- That archive predates source revision `7db7a98`. It proves the implemented signing boundary but is not the final source-matched release artifact. A new archive, notarization, source-revision binding, and physical permission matrix remain release gates.
